...
{   
    ...
    public void ApplyToMaterial(Material material)
    {
        ...
        Texture2DArray textureArray = GenerateTexureArray(layers.Select(x => x.texture).ToArray());
        material.SetTexture("baseTextures",textureArray);



        UpdateMeshHeight(material, savedMinHeight,saveMaxHeight);
    }
    ...
    Texture2DArray GenerateTexureArray(Texture2D[] textures)
    {
